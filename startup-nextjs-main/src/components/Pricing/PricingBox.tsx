...
const PricingBox = (props: {
  ...
  const { price, duration, packageName, subtitle, children, isPopular, onRequestQuote } = props;

  return (
    <div className="w-full">
      <div className={`shadow-three hover:shadow-one dark:bg-gray-dark dark:shadow-two dark:hover:shadow-gray-dark relative z-10 rounded-xs bg-white px-8 py-10 ${isPopular ? 'border-2 border-primary' : ''}`}>
        {isPopular && (
        ...
        <div className="border-body-color/10 mb-8 border-b pb-8 dark:border-white/10">
          <button
            ...
            className="bg-primary hover:bg-primary/90 hover:shadow-signUp flex w-full items-center justify-center rounded-xs p-3 text-base font-semibold text-white transition duration-300 ease-in-out"
          >
            Solicitar Orçamento
          </button>
        </div>
